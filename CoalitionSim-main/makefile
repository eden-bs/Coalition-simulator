...
bin/cRace: bin/main.o bin/Agent.o bin/Coalition.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/EdgeWeightSelectionPolicy.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o bin/MandatesSelectionPolicy.o bin/Neighbor.o 
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Coalition.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/EdgeWeightSelectionPolicy.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o bin/MandatesSelectionPolicy.o bin/Neighbor.o 
...
bin/Neighbor.o: src/Neighbor.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/Neighbor.o src/Neighbor.cpp
